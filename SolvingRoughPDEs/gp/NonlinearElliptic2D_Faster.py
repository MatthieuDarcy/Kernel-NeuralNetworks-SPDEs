...
"""
This file accelerates the computations in NonlinearElliptic2D.py by storing intermediate calculations. 
"""
...
class NonlinearElliptic2D(object):
    ...
    def prepare_data(self):
        ...
        eigen_func1 = lambda _i, _j, _qi, _qj, _wq: jnp.cos(_i * jnp.pi * _qi + _j * jnp.pi * _qj) * _wq #+ jnp.sin(_i * jnp.pi * _qi + _j * jnp.pi * _qj) * _wq
